...
const DEFAULT_ANNOUNCEMENTS: Announcement[] = [
  {
    id: '1',
    title: 'KaUREJEA KWA DARSA ZA KIELIMU',
    content: 'Darsa za kielimu zimerejea Ttena baada ya mapuzmiko mafupi kwa wanafunzi.',
    type: 'info',
    createdAt: new Date(),
    isActive: true,
  },
  {
    id: '2',
    title: 'DARSA MPYA KWA TAWHIID, KITABU: FADHILA ZA UISLAM (فضل الإسلام)',
    content:
      'Mwendelezo wa Darsa za Tawhiid na sasa ni kitabu فضل الإسلام, Darasa namba moja tayari "Utangulizi"',
    type: 'success',
    createdAt: new Date(),
    isActive: true,
  },
